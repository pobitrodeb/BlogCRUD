...
<head>
    <meta charset="utf-8">
    <title>pobitrodeb | personal blog</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free Website Template" name="pobitrodeb">
    <meta content="Free Website Template" name="pobitrodeb">

    <!-- Favicon -->
    <link href="{{asset('/')}}website_asset/{{asset('/')}}website_asset/img/favicon.ico" rel="icon">
...
<div class="wrapper">
    <div class="sidebar">
        <div class="sidebar-text d-flex flex-column h-100 justify-content-center text-center">
            ...
            <h1 class="font-weight-bold">POBITRO DEB</h1>
            <p class="mb-4">
            ...
            <a href="https://bd.linkedin.com/in/pobitrodeb" class="btn btn-lg btn-block btn-primary mt-auto" target="_blank">Hire Me</a>
        </div>
            ...
            <div id="blog-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="w-100" src="{{asset('/')}}website_asset/img/carousel-1.jpg" alt="Image">
                    ...
                    <div class="carousel-item">
                        <img class="w-100" src="{{asset('/')}}website_asset/img/carousel-2.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="carousel-item">
                        <img class="w-100" src="{{asset('/')}}website_asset/img/carousel-3.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <h2 class="text-white font-weight-bold">Lorem ipsum dolor sit amet</h2>
                            <div class="d-flex">
                                <small class="mr-2"><i class="fa fa-calendar-alt"></i> 01-Jan-2045</small>
    ...
    @yield('blog1')
        ...
        <div class="container bg-white pt-5">
            ...
            <div class="row blog-item px-3 pb-5">
                <div class="col-md-5">
                    <img class="img-fluid mb-4 mb-md-0" src="{{asset('/')}}website_asset/img/blog-5.jpg" alt="Image">
                </div>
                <div class="col-md-7">
        ...
        <div class="container py-4 bg-secondary text-center">
            <p class="m-0 text-white">
                &copy; <a class="text-white font-weight-bold" href="#">pobitrodeb</a>. All Rights Reserved. Develop by <a class="text-white font-weight-bold" href="https://github.com/pobitrodeb" target="_blank">POBITRO DEBNATH</a>
            </p>
        </div>
        <!-- Footer End -->
    </div>
